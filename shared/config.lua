...
Config.ImpoundLocations = { 
    [1] = vector4(435.31, -975.86, 25.7, 181.7), -- Mission Row PD
    [2] = vector4(-458.26, 6043.8, 31.34, 125.51), -- Paleto PD
    [3] = vector4(1842.36, 3692.41, 33.97, 300.36), -- Sandy PD
    [4] = vector4(860.09, -1358.05, 26.1, 77.36) -- La Mesa PD
